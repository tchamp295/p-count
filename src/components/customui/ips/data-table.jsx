...
const columns = [
  ...
  {
    accessorKey: "ip_postal_address",
    header: "Postal Address",
    cell: ({ row }) => <div>{row.getValue("ip_postal_address")}</div>,
  },
  {
  ...
  {
    accessorKey: "ip_contact_person",
    header: "Contact Person",
    cell: ({ row }) => <div>{row.getValue("ip_contact_person")}</div>,
  },
  {
  ...
  {
    accessorKey: "ip_contact_email",
    header: "Contact Email",
    cell: ({ row }) => <div>{row.getValue("ip_contact_email")}</div>,
  },
  {
    id: "actions",
    enableHiding: false,
