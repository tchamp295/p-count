        ...
        <fieldset className="grid gap-6 rounded-lg border p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="grid gap-3">
              ...
              <Select name="ipName" onValueChange={(value) => setFormData({ ...formData, ipName: value })}>
                <SelectTrigger>
            ...
            <div className="grid gap-3">
              ...
              <Select name="region" onValueChange={(value) => setFormData({ ...formData, region: value })}>
                <SelectTrigger>
            ...
            <div className="grid gap-3">
              ...
              <Select name="alertCategory" onValueChange={(value) => setFormData({ ...formData, alertCategory: value })}>
                <SelectTrigger>
